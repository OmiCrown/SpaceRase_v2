...
/*  я зависаю рядом с врагом - сделать обработку таких ситуаций
    я под врагом и не стреляю - уже есть пуля, нужно проверять есть ли пуля
            между мной и врагом
    я подвисаю на месте на тик - это когда суммарно команда стоп
    находить ближайшего врага - итерироваться по врагам, проверять,
            не не на нижней ли строчке, свободно ли под ним
    находить ближайшую зарядку - если пропала,
            может, еще один тик к ней, если не появилась, то сменять
    уворачиваться от пуль - если снизу, или снизу слева/справа */
}
